      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2"></h1>
			...
			<div class="col-md-12">
					...
					<?php else: ?>
						<form actio= "<?= base_url() ?>games/store" methods="post">
					<?php endif; ?>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="release_date" id="release_date" placeholder="release_date" value="<?= isset($game) ? $game["release_date"] : "" ?>" required>
						</div>
					</div>
